...
from app.core.utils.workers_cx.columns_names import CHAT_CUSTOMER, CHAT_RIDER, MAIL_CUSTOMER, MAIL_RIDER, MAIL_VENDORS, MAIL_CUSTOMER_MC, MAIL_CUSTOMER_IS, CALL_VENDORS, GLOVO_SPAIN, GERENCIA, UPDATE 
